...
const TabMISITW = () => {
            ...
            try {
                const response = await fetch(
                    "http://localhost:3500/admin/masters",
                    {
                        ...
                        body: JSON.stringify({
                            master: "master ingenierie des systemes informatiques et technologies web",
                        }),
                    }
                );
    ...
    const exportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "MISITW");
        XLSX.writeFile(wb, "MISITW.xlsx");
    };
    let printable = [];
    return (
        <>
