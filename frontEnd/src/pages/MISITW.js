...
const MCSTC = () => {
    const applyMisitw = () => {
        sessionStorage.setItem(
            "master",
            "master ingenierie des systemes informatiques et technologies web"
        );
        sessionStorage.setItem("licence", null);
        ...
        <div>
            ...
            <div className="container">
                <h1 style={{ textAlign: "center", margin: "40px" }}>
                    MASTER INGENIERIE DES SYSTEMES INFORMATIQUES ET TECHNOLOGIES
                    WEB
                </h1>
                        ...
                        <div className="card m-1">
                            <div className="card-body">
                                <h3
                                    ...
                                    style={{ fontWeight: "500" }}
                                >
                                    Master Techniques de Management
                                </h3>
                            </div>
                            <ul className="list-group list-group-flush">
