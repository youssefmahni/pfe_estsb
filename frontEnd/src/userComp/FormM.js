...
const FormM = ({ email, setApplicant, setSecond, setToPrint }) => {
    ...
    const [master, setMaster] = useState("master one one");
    const licence = null;
    const [diplom, setDiplom] = useState("");

    const applyMaster = async (e) => {
        e.preventDefault();
    ...
    return (
        <div className="m-5 mt-0">
            <h1>Master Application Form</h1>
            <form className="row g-3" onSubmit={applyMaster}>
                {/* first name */}
                ...
                <div className="col-md-6">
                    <label for="diplom" class="form-label">
                        diplom
                    </label>
                    <input
                        class="form-control is-valid"
